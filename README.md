...
💻 Interested in building real-world web applications using **Python and Django**

🔌 Experience with **REST API development and testing**

🗄️ Comfortable with **MySQL and database operations**

🌐 Frontend knowledge in **HTML, CSS and JavaScript**

🔧 Development tools: **Git, GitHub, Postman and VS Code**
...
| 💼 Career | Open to entry-level opportunities |

---

# 🎯 What I Build

| 🐍 Backend | 🌐 Full Stack | 🗄️ Database |
|---|---|---|
| Django Applications | Responsive Websites | MySQL |
| REST APIs | CRUD Applications | Database Design |
| Authentication | API Integration | SQL Queries |
| Database Integration | Frontend + Backend | CRUD Operations |
